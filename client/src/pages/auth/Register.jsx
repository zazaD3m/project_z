      ...
      <div className="flex w-full flex-col items-center rounded-md bg-primary-foreground p-8 shadow-sm">
        ...
        >
          <div className="flex flex-col space-y-6">
            <Input label="First Name" id="registerFormFirstName" type="text" />
            <Input label="Last Name" id="registerFormLastName" type="text" />
            <Input label="Email" id="registerFormEmail" type="email" />
            <Input label="Password" id="registerFormPassword" type="password" />
        ...
        <Link
          to="/account/login"
          className="mt-4 text-center text-xs underline underline-offset-2 hover:text-blue-400"
        >
